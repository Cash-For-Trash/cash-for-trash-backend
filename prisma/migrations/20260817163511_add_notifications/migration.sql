...
ALTER TABLE `Notification` ADD COLUMN `related_id` VARCHAR(191) NULL,
    ADD COLUMN `type` ENUM('REQUEST_CREATED', 'REQUEST_NEEDS_RESCHEDULE', 'REQUEST_ACCEPTED', 'REQUEST_ON_THE_WAY', 'REQUEST_COLLECTED', 'REQUEST_CANCELLED', 'PAYMENT_SUCCESS', 'PAYMENT_FAILED', 'POINTS_EARNED', 'REWARD_REQUESTED', 'REWARD_APPROVED', 'REWARD_REJECTED', 'REWARD_DELIVERED', 'SYSTEM') NOT NULL DEFAULT 'SYSTEM';
